...
/* harmony import */ var _modules_map_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/map.js */ "./src/modules/map.js");
...
var vomap = new _modules_map_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
...
var parcheggi = new _modules_map_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  ...
  this.svg = null, this.container = null, this.scale = 1, this.initDraggable = function () {
    gsap_Draggable__WEBPACK_IMPORTED_MODULE_1__.Draggable.create(_this.svg, {
      inertia: true,
      bounds: _this.container,
      allowEventDefault: true,
      cursor: 'auto'
    });
  };
  this.initZoomButtons = function () {
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(_this.svg, {
      scale: _this.scale
    });
    var zoomInButton = _this.container.querySelector('.zoomin');
    var zoomOutButton = _this.container.querySelector('.zoomout');
    if (zoomOutButton) {
  ...
  this.zoomIn = function () {
    ...
    _this.scale += 0.2;
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(_this.svg, {
      scale: _this.scale,
      ease: "none",
      duration: 0.2
    });
  ...
  this.initModalShapes = function (data) {
    data.forEach(function (shape_data) {
      var shape = _this.svg.querySelector('[data-name="' + shape_data.name + '"]');
      if (!shape) {
        return;
      }
      shape.style.cursor = 'pointer';
      shape.querySelectorAll('[data-hover]').forEach(function (hover) {
        hover.style.display = 'none';
      });
      shape.addEventListener('click', function () {
        if (shape_data.level) {
          if (_this.checkDisabled(shape_data.level)) {
            return;
          }
        }
        _this.UIkit.modal('.' + shape_data.modal).show();
      });
  ...
  this.checkDisabled = function (name) {
    return _this.svg.querySelector('[data-name="' + name + '"]').hasAttribute('data-disabled');
  };
  this.initToggleButtons = function (data) {
    data.forEach(function (toggle_data) {
      var toggles = _this.svg.querySelectorAll('[data-name="' + toggle_data.name + '"]');
      var toggleables = _this.container.querySelectorAll('[data-toggle="' + toggle_data.name + '"]');
      toggleables.forEach(function (toggleable) {
        ...
        toggleable.addEventListener('change', function (e) {
          toggles.forEach(function (toggle) {
            if (e.target.checked) {
              toggle.style.display = 'block';
            } else {
  ...
  }, this.initLevelButton = function (data) {
    var levelButton = _this.container.querySelector('.levels');
    if (!levelButton) {
      return;
    }
    var currentLevel = 0;
    var buttonLevels = levelButton.querySelectorAll('span');
    function setButtonLevel() {
      buttonLevels.forEach(function (buttonLevel, key) {
        if (key === currentLevel) {
    ...
    if (levelButton) {
      levelButton.addEventListener('click', function () {
        ...
        setButtonLevel();
        data.forEach(function (level_data, key) {
          var level = _this.svg.querySelector('[data-name="' + level_data.name + '"]');
          if (currentLevel === 0) {
  ...
  }, this.init = function (selector, shapes_data, toggles_data, levels_data) {
    var initial_scale = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 1;
    _this.container = document.querySelector(selector);
    if (!_this.container) {
      return;
    }
    _this.svg = _this.container.querySelector(':scope > svg');
    if (!_this.svg) {
      return;
    }
    ...
    _this.initDraggable();
    _this.initZoomButtons();
    _this.initModalShapes(shapes_data);
    _this.initToggleButtons(toggles_data);
    _this.initLevelButton(levels_data);
  };
}
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkvomaps"] = self["webpackChunkvomaps"] || [];
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["dist/app"], () => (__webpack_require__("./src/app.less")))
